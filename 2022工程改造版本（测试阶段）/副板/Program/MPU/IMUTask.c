...
MPU9250_DATA   MPU9250_Offest_Data;
MPU9250_DATA_t MPU6500_Offest_data;
mpu6500_real_data_t mpu6500_real_data; //MPU原始数据

//float imu_test_pitch, imu_test_roll, imu_test_yaw;
//float imu_test_gx, imu_test_gy, imu_test_gz, imu_test_ax, imu_test_ay, imu_test_az;

Angular_Handle  Angular_Handler;   //用于内环的角速度
...
{
//	IMU_Pid.ref = 30;
//	IMU_Pid.fdb = Angular_Handler.Temp;
//	PID_Control(&IMU_Pid);
//	VAL_LIMIT(IMU_Pid.pid_out,0,1000);
//	SetImuTemp(IMU_Pid.pid_out);
}
//陀螺仪零偏校准
void IMU_Calibration(void)
{
	...
	MPU9250_Offest_Data.Gyro_X =g_Gyro_xoffset/100;//得到标定偏移
	MPU9250_Offest_Data.Gyro_Y =g_Gyro_yoffset/100;
	MPU9250_Offest_Data.Gyro_Z =g_Gyro_zoffset/100;
...
//		X_Origion=(K[0]*MPU9250_Raw_Data.Accel_X-B[0])*ACCEL_TO_1G;//经过椭球校正后的三轴加速度量
//		Y_Origion=(K[1]*MPU9250_Raw_Data.Accel_Y-B[1])*ACCEL_TO_1G;
//		Z_Origion=(K[2]*MPU9250_Raw_Data.Accel_Z-B[2])*ACCEL_TO_1G;
...
//	imu_test_gx=MPU9250_Real_Data.Gyro_X;
//	imu_test_gy=MPU9250_Real_Data.Gyro_Y;
//	imu_test_gz=MPU9250_Real_Data.Gyro_Z;
//	imu_test_ax=MPU9250_Real_Data.Accel_X; 
//	imu_test_ay=MPU9250_Real_Data.Accel_Y;
//	imu_test_az=MPU9250_Real_Data.Accel_Z;
//	imu_test_pitch = Angular_Handler.Pitch;
//	imu_test_roll = Angular_Handler.ROLL;
//	imu_test_yaw = Angular_Handler.YAW;
}
