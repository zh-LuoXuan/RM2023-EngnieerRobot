...
/**
  ...
  * @retval void
  */
void Get_MOUSExyz_Data(RC_ctrl_t* RC_Ctl,CanRxMsg *msg)
{

	RC_Ctl->mouse.x = (msg->Data[0]<<8)| msg->Data[1];
	RC_Ctl->mouse.y  = (msg->Data[2]<<8)| msg->Data[3];
	RC_Ctl->mouse.z  = (msg->Data[4]<<8)| msg->Data[5];
